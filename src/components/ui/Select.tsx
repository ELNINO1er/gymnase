...
export function Select({ value, onChange, options, placeholder = "Selectionner..." }: SelectProps) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {/* Dropdown */}
      {open && (
        <div className="absolute z-50 mt-1.5 w-full min-w-[180px] bg-zinc-900 border border-zinc-700/50 rounded-xl shadow-2xl shadow-black/50 py-1 overflow-hidden">
          {options.map((option) => {
